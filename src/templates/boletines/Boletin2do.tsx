...
export default function Boletin2do({ curso, estudiantes, docenteNombre, studentGrades, state }: BoletinTemplateProps) {
    return (
        <>
            <style dangerouslySetInnerHTML={{ __html: `
                ...
                * { box-sizing: border-box; }
                ...
                .boletin-title{ color:#0072bc; font-weight:bold; font-size:17px; margin-top:9px; }
                        ...
                        <div className="page portrait">
                          ...
                          <div className="p1-container">
                            ...
                            <div className="p1-right">
                              ...
                              <div style={{ margin: '14px 0', border: '1.5px solid #1c3f5f', padding: '6px', borderRadius: '4px', background: '#cfe3f2' }}>
                                <div style={{ fontSize: '11px', fontWeight: 'black', color: '#1c3f5f', letterSpacing: '1.5px' }}>NIVEL EDUCACIÓN SECUNDARIA</div>
                                <div style={{ fontSize: '9px', fontWeight: 'bold', color: '#1c3f5f', marginTop: '2px' }}>{curso.grado} Grado - Primer Ciclo</div>
                              </div>
