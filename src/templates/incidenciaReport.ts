...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .header { display: flex; justify-content: space-between; align-items: center; border-bottom: 3px solid #7A8D69; padding-bottom: 16px; margin-bottom: 24px; }
  .brand { font-size: 13px; font-weight: 800; letter-spacing: 0.14em; text-transform: uppercase; color: #7A8D69; }
  ...
  .section h2 { font-size: 11px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.12em; color: #7A8D69; border-left: 4px solid #BFC9A6; padding-left: 10px; margin-bottom: 8px; }
