        ...
        try {
            ...
            const mappedPerfiles = (perfiles || []).map((p: any): UserProfile => {
                ...
                return {
                    ...
                    trial_extension_activated_at: p.trial_extension_activated_at as string || null,
            ...
            if (!mappedPerfiles.find((p: UserProfile) => p.userId === session.user.id)) {
                ...
                mappedPerfiles.unshift({
                    ...
                    createdAt: (miPerfil as any).created_at as string,
                    trial_extension_activated_at: (miPerfil as any).trial_extension_activated_at as string || null,
