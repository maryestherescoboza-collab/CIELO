    ...
    return (
        <aside className="space-y-5">
            ...
            <section className="bg-[#FDFBF7] rounded-[20px] border border-[rgba(46,51,48,0.08)] p-5 shadow-sm">
                <h3 className="text-xs font-black uppercase tracking-[0.2em] text-[#2E3330] mb-2.5">
                    asignatura
                </h3>
                <div className="relative">
                    <select 
                        ...
                        className="w-full h-10 pl-4 pr-10 bg-[#FDFBF7] border border-slate-300 rounded-full text-xs font-bold text-[#2E3330] focus:outline-none focus:border-primary transition-all appearance-none cursor-pointer lowercase artisan-pill"
                        style={{
            ...
            <section className="bg-[#FDFBF7] rounded-[20px] border border-[rgba(46,51,48,0.08)] p-5 shadow-sm">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xs font-black uppercase tracking-[0.2em] text-[#2E3330] m-0">
                        top colaboradores
                    </h3>
                </div>
                        ...
                        >
                            <div className="flex items-center gap-3 min-w-0">
                                ...
                                <div className="flex flex-col min-w-0">
                                    ...
                                    <span className="text-xs font-black uppercase tracking-widest text-[#5F665E] truncate max-w-30">{profile.asignatura?.toLowerCase()}</span>
                                </div>
                            </div>
