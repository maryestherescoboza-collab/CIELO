                    ...
                    <div className="sticky top-0 z-40 bg-[#F8F3ED] text-[#2E3330] border-b border-[rgba(46,51,48,0.08)] flex min-w-max w-max">
                        {COLUMNS.map(col => {
                            ...
                            if (col.type === 'estudiantes') {
                                return (
                                    <div key={col.id} className="sticky left-0 z-50 bg-[#F8F3ED] px-6 py-5 text-left border-r border-[rgba(46,51,48,0.08)] flex items-center justify-between box-border" style={style}>
                            ...
                            if (col.type === 'actividad') {
                                const act = col.act;
                                return (
                                    <div key={col.id} className="px-2 py-4 border-r border-[rgba(46,51,48,0.08)] relative group flex flex-col items-center justify-center box-border" style={style}>
                            ...
                            if (col.type === 'destaca') {
                                return (
                                    <div key={col.id} className="px-4 py-4 border-r border-[rgba(46,51,48,0.08)] bg-warning/10 flex flex-col items-center justify-center box-border" style={style}>
                            ...
                            if (col.type === 'bc-avg') {
                                ...
                                return (
                                     <div key={col.id} className={`px-2 pb-2 pt-4 border-r border-[rgba(46,51,48,0.08)] flex flex-col items-center justify-end box-border relative ${col.idx === 0 ? 'border-l-2 border-l-[rgba(46,51,48,0.08)]' : ''}`} style={style}>
                            ...
                            if (col.type === 'bc-rec') {
                                return (
                                    <div key={col.id} className="px-4 py-4 border-r border-[rgba(46,51,48,0.08)] bg-primary/5 flex flex-col items-center justify-center box-border" style={style}>
                            ...
                            return (
                                ...
                                >
                                    {COLUMNS.map(col => {
                                        ...
                                        if (col.type === 'estudiantes') {
                                            return (
                                                <div key={col.id} className="sticky left-0 z-20 bg-inherit px-6 py-3 border-r border-[rgba(46,51,48,0.08)] font-semibold text-[#2E3330] flex items-center box-border" style={style}>
                                        ...
                                        if (col.type === 'destaca') {
                                            return (
                                                <div key={col.id} className="px-3 py-3 border-r border-[rgba(46,51,48,0.08)] flex items-center justify-center box-border bg-[#FDFBF7]" style={style}>
                                                    {est.destaca && (
                                        ...
                                        if (col.type === 'bc-avg') {
                                            ...
                                            return (
                                                <div key={col.id} className={`px-3 py-3 border-r border-[rgba(46,51,48,0.08)] flex items-center justify-center box-border ${col.idx === 0 ? 'border-l-2 border-l-[rgba(46,51,48,0.08)]' : ''}`} style={style}>
