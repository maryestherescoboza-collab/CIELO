                ...
                <div className="bg-white rounded-[2rem] shadow-sm border border-[rgba(46,51,48,0.08)] overflow-hidden min-w-max w-max">
                    ...
                    <div className="sticky top-0 z-40 bg-[#F8F3ED] text-[#2E3330] border-b border-[rgba(46,51,48,0.08)] flex min-w-max w-max">
                        {COLUMNS.map(col => {
                                        ...
                                        <div className="flex flex-col items-center gap-4 w-full">
                                            <div className="flex items-center gap-2 w-full justify-center px-1">
                                                ...
                                                <input 
                                                    ...
                                                    className="text-sm font-black uppercase tracking-wider text-[#5F665E] hover:text-[#2E3330] focus:text-[#2E3330] bg-transparent outline-none text-center w-full max-w-30 truncate focus:border-b focus:border-[#ADC762]/30 transition-all placeholder:text-[#5F665E]/40"
                                                    placeholder="NOMBRE"
                                                />
                                            </div>
                            ...
                            if (col.type === 'bc-rec') {
                                return (
                                    <div key={col.id} className="px-4 py-6 border-r border-[rgba(46,51,48,0.08)] bg-[#ADC762]/5 flex flex-col items-center justify-center box-border" style={style}>
                                        <span className="text-xs font-black uppercase tracking-widest text-[#ADC762]/70">Rec.</span>
                                    </div>
                                );
                            }
                            return null;
