...
export const MOCK_STATE: AppState = {
    ...
    descriptoresRubrica: [],
    nivelesPuntaje: [
        { nivel: 4, nombre: 'Estratégico', puntaje: 100, color: '#F5BC5D', description: 'Lidera procesos, propone soluciones innovadoras y actúa de manera autónoma y creativa.' },
        { nivel: 3, nombre: 'Autónomo', puntaje: 85, color: '#537BAC', description: 'Realiza las tareas por sí solo, cumpliendo los objetivos con eficiencia.' },
        { nivel: 2, nombre: 'Resolutivo', puntaje: 70, color: '#689C63', description: 'Identifica el problema y aplica procedimientos básicos para resolverlo.' },
        { nivel: 1, nombre: 'Receptivo', puntaje: 55, color: '#EB8847', description: 'Requiere apoyo continuo para comprender tareas y alcanzar los objetivos.' },
    ],
    evaluacionesRubrica: [],
    criteriosCotejo: [],
    evaluacionesCotejo: [],
